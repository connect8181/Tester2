...
LIVE_MODE = True  # Neuer Parameter für Live-Modus
...
if LIVE_MODE:
        ...
        if now.minute % 5 == 0 and (last_seen_time is None or now != last_seen_time):
            ...
            try:
                ...
                if position == 0 and pred == 1 and prob > BUY_PROB_THRESHOLD:
                    ...
                    position = 1
                    print(f"🟢 Einstieg bei {close_price:.2f} USDT")
                    ...
                    if close_price <= entry_price * (1 - STOP_LOSS_PCT):
                        ...
                        print(f"🔻 Stop Loss bei {close_price:.2f} USDT | PnL: {pnl:.2f}")
                        position = 0
                        btc_amount = 0
                        ...
                        capital = btc_amount * close_price - fee_sell
                        total_fees_paid += fee_sell
                        print(f"🟢 Take Profit bei {close_price:.2f} USDT | PnL: {pnl:.2f}")
                        position = 0
                        btc_amount = 0
                        ...
                        capital = btc_amount * close_price - fee_sell
                        total_fees_paid += fee_sell
                        print(f"⏳ Trail Stop bei {close_price:.2f} USDT | PnL: {pnl:.2f}")
                        position = 0
                        btc_amount = 0
    ...
    print("Live-Modus ist deaktiviert.")
